...
local mylaunchbar = launchbar("/home/fridge/Desktop/launchbar")
-- }}}
...
modkey     = "Mod4"
altkey     = "Mod1"
terminal   = os.getenv("TERMINAL") or "termite" or "urxvtc" or "xterm"
...
-- {{{ Tags
tags = {
    names = { "WWW", "TERMINAL", "CODE", "FILES", "OTHER" },
    layout = { layouts[3], layouts[5], layouts[5], layouts[4], layouts[5] }
}
...
client.connect_signal("manage", function (c, startup)
    ...
    if titlebars_enabled and (c.type == "normal" or c.type == "dialog") then
        ...
        awful.titlebar(c,{position="bottom", size=16}):set_widget(layout)
    end
end)
